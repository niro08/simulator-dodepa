...
| TD-15 | ✅ | gameplay-programmer, 2026-09-25: инварианты рана v2 (`invariants.ts`: ⚡ ≤ 100, ❤️ ∈ [−15; 40], 🔥 ∈ [0; 100], деньги ≥ 0) после каждой команды и при загрузке; B-05 сверху — фиксированные таблицы наград (смена 630…2048, друзья {0}∪[50;800]), `reward.ts` удалён; B-06 — проигрыш не даёт ⚡, регресс-тест economy §10 (`balance.test.ts`), фаззинг 10⁴ команд (`reducer.test.ts`) |
